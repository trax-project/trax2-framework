...
trait RevealStatements
{
    ...
    protected function revealStatement(object $statement, array $agents, bool $removeNames = false): object
    {
        ...
        if (isset($statement->context->instructor)
            && (!isset($statement->context->instructor->objectType) || $statement->context->instructor->objectType == "Agent")) {
                $this->revealAgent($statement->context->instructor, $agents, $removeNames);
        }
        // Instructor group.
        if (isset($statement->context->instructor)
            && isset($statement->context->instructor->objectType)
            && $statement->context->instructor->objectType == "Group") {
